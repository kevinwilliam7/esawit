@php
    $legalitas = [['view' => 'AMDAL', 'name' => 'amdal'], ['view' => 'SIUP', 'name' => 'siupp'], ['view' => 'SITU', 'name' => 'situ'], ['view' => 'HGB', 'name' => 'hgb'], ['view' => 'IMB Pabrik', 'name' => 'imb_pabrik'], ['view' => 'IMB Perumahan', 'name' => 'imb_perumahan'], ['view' => 'Izin Gangguan HO', 'name' => 'ijin_gangguan'], ['view' => 'Izin Pembuangan Air Limbah', 'name' => 'ijin_limbah_cair'], ['view' => 'Izin Radio', 'name' => 'ijin_radio'], ['view' => 'Land Application', 'name' => 'land_aplikasi'], ['view' => 'Izin Mesin-Mesin Pabrik', 'name' => 'mesin_pabrik'], ['view' => 'Izin Timbang', 'name' => 'ijin_timbang']];
@endphp
                ...
                <div class="accordion-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <textarea name="keterangan_{{ $legal['name'] }}" cols="30" rows="5">{{ old('keterangan'.$legal['view']) }}</textarea>
                            @error($legal['name'])
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
