    ...
    <div class="accordion-body">
        <div class="row">
            ...
            <div class="col-12 col-lg-6 mb-3">
                ...
                <input type="text" name="npwp" class="form-control" value="{{ old('npwp') }}" minlength="10"
                    required>
                @error('npwp')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="col-12 mb-3">
                ...
                <textarea type="text" name="alamat_kantor" class="form-control" row=5 required>{{ old('alamat_kantor') }}</textarea>
                @error('alamat_kantor')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 col-lg-6 mb-3">
                ...
                <input type="number" min="1900" max="{{ date('Y') }}" name="tahun_operasi"
                    class="form-control" value="{{ old('tahun_operasi') }}">
                @error('tahun_operasi')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 col-lg-6 mb-3">
                ...
                <input type="text" name="nama_grup" class="form-control" value="{{ old('nama_grup') }}">
                @error('nama_grup')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 mb-3">
                ...
                <input type="number" name="bursa_efek" class="form-control" value="{{ old('bursa_efek') }}">
                @error('bursa_efek')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="number" name="tenaga_kerja_wni" min="0" id="wni"
                            value="{{ old('tenaga_kerja_wni') }}" class="form-control">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="number" name="tenaga_kerja_asing" min="0" id="wna"
                            value="{{ old('tenaga_kerja_asing') }}" class="form-control">
