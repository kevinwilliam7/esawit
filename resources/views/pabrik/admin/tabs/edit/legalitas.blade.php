                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text" name="nomor_{{ $legal['name'] }}" class="form-control"
                                value="{{ $pabrik->{'nomor_' . $legal['name']} }}">
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text" name="penjabat_{{ $legal['name'] }}" class="form-control"
                                value="{{ $pabrik->{'penjabat_' . $legal['name']} }}">
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="date" name="ditetapkan_{{ $legal['name'] }}" class="form-control"
                                value="{{ $pabrik->{'ditetapkan_' . $legal['name']} }}">
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="date" name="berakhir_{{ $legal['name'] }}" class="form-control"
                                value="{{ $pabrik->{'berakhir_' . $legal['name']} }}">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="keterangan_{{ $legal['name'] }}" cols="30" rows="5" class="form-control">{{ $pabrik->{'keterangan_'.$legal['name']} }}</textarea>
                            @error($legal['name'])
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
