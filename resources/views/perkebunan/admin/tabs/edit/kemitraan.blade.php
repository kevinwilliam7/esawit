<div class="row">
    <div class="col-12 col-lg-6 mb-3">
        ...
        <input type="number" name="kk_target_plasma" class="form-control" value="{{ $perkebunan->kk_target_plasma }}">
    ...
    <div class="col-12 col-lg-6 mb-3">
        ...
        <input type="number" step="0.01" name="ha_target_plasma" class="form-control"
            value="{{ $perkebunan->ha_target_plasma }}">
    ...
    <div class="col-12 col-lg-6 mb-3">
        ...
        <input type="number" step="0.01" name="ha_realisasi_plasma" class="form-control"
            value="{{ $perkebunan->ha_realisasi_plasma }}">
    ...
    <div class="col-12">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="pola_kemitraan" id="kemitraan-mandiri"
                value="kemitraan mandiri" {{ $perkebunan->pola_kemitraan === 'kemitraan mandiri' ? 'checked' : '' }}>
