...
<head>
  ...
  <link href="assets/green/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope-fill"></i><a href="mailto:contact@example.com">dpp@sanggau.go.id</a>
        <i class="bi bi-phone-fill phone-icon"></i> 0564-2023528/2023503
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
            ...
            <li class="dropdown"><a href="#services"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                <li><a href="#">Perusahaan Perkebunan</a></li>
      ...
      <div class="container">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/images/partner/pemkab_sanggau.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/images/partner/elpagar.png" class="img-fluid" alt=""></div>
          </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright 2023 <strong><span>Elpagar</span></strong>- Lembaga Pemberdayaan Pergerakan Rakyat.
      </div>
      <div class="credits">
