...
class StorePerkebunanRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'tanggal_akta_pendirian' => 'nullable|date|required_with:nomor_akta_pendirian',
            'notaris_akta_pendirian' => 'nullable|string|required_with:nomor_akta_pendirian',
            'komisaris_akta_pendirian' => 'nullable|string|required_with:nomor_akta_pendirian',
            'direktur_akta_pendirian' => 'nullable|string|required_with:nomor_akta_pendirian',
            'nomor_akta_perubahan' => 'nullable|string',
            'tanggal_akta_perubahan' => 'nullable|date|required_with:nomor_akta_perubahan',
            'notaris_akta_perubahan' => 'nullable|string|required_with:nomor_akta_perubahan',
            'komisaris_akta_perubahan' => 'nullable|string|required_with:nomor_akta_perubahan',
            'direktur_akta_perubahan' => 'nullable|string|required_with:nomor_akta_perubahan',
